...
{
    public class RequestContentTypeProvider : IRequestContentTypeProvider
    {
        ...
        {
            var contentType = headers.FirstOrDefault(x => x.Key.Equals("Accept", StringComparison.OrdinalIgnoreCase));
